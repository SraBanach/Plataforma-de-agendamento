...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/04/2025 às 08:58
...
INSERT INTO `tb_agendamento` (`id`, `servico`, `valor`, `horario`, `data_agendamento`, `observacoes`) VALUES
(1, 'Extensão de Cílios', 120, '10:00:00', '2025-04-11', 'teste mesmo dia e horario '),
(2, 'Extensão de Cílios', 120, '10:00:00', '2025-04-05', ''),
(3, 'Design de Sobrancelhas', 50, '11:00:00', '2025-04-11', ''),
(4, 'Hidratação Capilar', 80, '12:00:00', '2025-04-11', 'teste'),
(7, 'Design de Sobrancelhas', 50, '10:00:00', '2025-04-05', ''),
(8, 'Hidratação Capilar', 80, '10:00:00', '2025-04-05', ''),
(11, 'Design de Sobrancelhas', 50, '10:00:00', '2025-04-05', '');
...
(1, 'unha', '45 min ', 'Manicure ', ' 50.00', '15 dias', 'sghsfj', '', '', ''),
(2, 'Design de Sobrancelhas', '30 minutos', 'Estética', ' 50,00', '1 semana', 'Design de sobrancelhas, natural e duradouro.', 'foto1.jpg', 'foto2.jpg', 'foto3.jpg'),
(3, 'Extensão de Cílios', '60 minutos', 'Estética', ' 120,00', '10 dias', 'Extensão de cílios volumosa e natural.', 'extensao1.jpg', 'extensao2.jpg', 'extensao3.jpg'),
(4, 'Hidratação Capilar', '40 minutos', 'Beleza', ' 80,00', '2 semanas', 'Hidratação profunda para fios danificados.', 'hidratacao1.jpg', 'hidratacao2.jpg', 'hidratacao3.jpg'),
(5, 'Limpeza de Pele', '50 minutos', 'Estética', ' 90,00', '1 mês', 'Limpeza profunda da pele, ideal para todos os tipos.', 'limpeza1.jpg', 'limpeza2.jpg', 'limpeza3.jpg'),
(6, 'Corte de Cabelo Masculino', '30 minutos', 'Corte de Cabelo', '40,00', '1 semana', 'Corte de cabelo moderno, com estilo.', 'corte1.jpg', 'corte2.jpg', 'corte3.jpg');
...
(9, 'kenyalinda@gmail.com', '123456'),
(10, 'kenyalinda@gmail.com', '123456'),
(11, 'kenyalinda@gmail.com', '123456'),
(12, 'kenyalinda@gmail.com', '123456'),
(13, 'kenyalinda@gmail.com', '123456'),
(14, 'kenyalinda@gmail.com', '123456'),
(15, 'kenyalinda@gmail.com', '123456'),
(16, 'kenyalinda@gmail.com', '123456'),
(17, 'kenyalinda@gmail.com', '123456'),
(18, 'kenyalinda@gmail.com', '123456'),
(19, 'kenyalinda@gmail.com', '123456'),
(20, 'kenyalinda@gmail.com', '123456');
...
--
ALTER TABLE `tb_login`
  MODIFY `id_login` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
COMMIT;
